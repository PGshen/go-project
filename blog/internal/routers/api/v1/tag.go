...
import (
	...
	"github.com/PGshen/go-project/blog/internal/service"
	"github.com/PGshen/go-project/blog/pkg/app"
	"github.com/PGshen/go-project/blog/pkg/convert"
...
func (t Tag)List(c *gin.Context)  {
	...
	if err != nil {
		global.Logger.Errorf("app.CountTag err: %v", err)
	...
	if err != nil {
		global.Logger.Errorf("app.GetTagList err: %v", err)
...
func (t Tag)Create(c *gin.Context)  {
	...
	if err != nil {
		global.Logger.Errorf("app.CreateTag err: %v", err)
...
func (t Tag)Update(c *gin.Context)  {
	...
	if err != nil {
		global.Logger.Errorf("app.UpdateTag err: %v", err)
...
func (t Tag)Delete(c *gin.Context)  {
	...
	if err != nil {
		global.Logger.Errorf("app.DeleteTag err: %v", err)
